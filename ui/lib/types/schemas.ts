...
export const providerPricingOverrideSchema = z
	.object({
		...
		input_cost_per_token_above_200k_tokens_priority: z.number().min(0).optional(),
		output_cost_per_token_above_200k_tokens: z.number().min(0).optional(),
		output_cost_per_token_above_200k_tokens_priority: z.number().min(0).optional(),
		...
		cache_read_input_token_cost_above_200k_tokens_priority: z.number().min(0).optional(),
		input_cost_per_token_above_272k_tokens: z.number().min(0).optional(),
		input_cost_per_token_above_272k_tokens_priority: z.number().min(0).optional(),
		output_cost_per_token_above_272k_tokens: z.number().min(0).optional(),
		output_cost_per_token_above_272k_tokens_priority: z.number().min(0).optional(),
		cache_read_input_token_cost_above_272k_tokens: z.number().min(0).optional(),
		cache_read_input_token_cost_above_272k_tokens_priority: z.number().min(0).optional(),
