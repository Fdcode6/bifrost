...
type LogManager interface {
	...
	// GetFinalSuccessDistribution returns final-success distribution for grouped routing analysis
	GetFinalSuccessDistribution(ctx context.Context, filters *logstore.SearchFilters, groupBy logstore.FinalSuccessDistributionDimension) (*logstore.FinalSuccessDistributionResult, error)
...
func (p *PluginLogManager) GetFinalSuccessDistribution(ctx context.Context, filters *logstore.SearchFilters, groupBy logstore.FinalSuccessDistributionDimension) (*logstore.FinalSuccessDistributionResult, error) {
	if filters == nil {
		return nil, fmt.Errorf("filters cannot be nil")
	}
	return p.plugin.GetFinalSuccessDistribution(ctx, *filters, groupBy)
}
