...
func validatePricingOverrideNonNegativeFields(index int, override schemas.ProviderPricingOverride) error {
	optionalValues := map[string]*float64{
		...
		"input_cost_per_token_above_200k_tokens_priority":          override.InputCostPerTokenAbove200kTokensPriority,
		"output_cost_per_token_above_200k_tokens_priority":         override.OutputCostPerTokenAbove200kTokensPriority,
		"cache_read_input_token_cost_above_200k_tokens_priority":   override.CacheReadInputTokenCostAbove200kTokensPriority,
		"input_cost_per_token_above_272k_tokens":                   override.InputCostPerTokenAbove272kTokens,
		"input_cost_per_token_above_272k_tokens_priority":          override.InputCostPerTokenAbove272kTokensPriority,
		"output_cost_per_token_above_272k_tokens":                  override.OutputCostPerTokenAbove272kTokens,
		"output_cost_per_token_above_272k_tokens_priority":         override.OutputCostPerTokenAbove272kTokensPriority,
		"cache_read_input_token_cost_above_272k_tokens":            override.CacheReadInputTokenCostAbove272kTokens,
		"cache_read_input_token_cost_above_272k_tokens_priority":   override.CacheReadInputTokenCostAbove272kTokensPriority,
